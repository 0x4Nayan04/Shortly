const UserProfileModal = ({ isOpen, onClose, user, userStats }) => {
	...
	return (
		<div className='fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4 bg-black'>
			<div className='bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto scrollbar-hide'>
				{/* Header */}
