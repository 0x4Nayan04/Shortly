...
const ShareModal = memo(({ isOpen, onClose, shortUrl, fullUrl }) => {
  ...
  const shareActions = [
    ...
    {
      label: 'X',
      icon: <XBrandIcon className='size-5' />,
      circleClass:
        ...
        <div className='flex flex-col gap-6'>
          ...
          <div className='flex flex-col items-center justify-center bg-surface-muted border border-border p-4 rounded-sm'>
            {qrDataUrl ? (
              ...
              <div className='size-40 flex items-center justify-center text-muted'>
          ...
          <div className='grid grid-cols-4 gap-3 pt-5 border-t border-border'>
            {visibleShareActions.map((action) => (
              <button
                ...
                <div
                  className={`flex items-center justify-center size-12 rounded-full border border-border bg-surface shadow-sm transition-all duration-200 group-hover:scale-105 group-hover:shadow-md group-focus-visible:ring-2 group-focus-visible:ring-primary group-focus-visible:ring-offset-2 ${
                    action.circleClass ??
